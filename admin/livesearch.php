    	...
    	while($row = mysqli_fetch_assoc($query_run)){
    		...
    		?>
    			<tr>
    				...
    				<td><?php if($status == 0){?> <a href="park_vehical.php?vno=<?php echo $vehical_no;?>" class="btn btn-sm btn-success">Park Vehical</a> <?php }else{ ?> <a href="unpark_vehical.php?vno=<?php echo $vehical_no;?>" class="btn btn-sm btn-danger">Un-Park Vehical</a> <?php }?></td>
    			</tr>
    		<?php 
    	}
        ?>
